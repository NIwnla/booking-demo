...
// @ts-ignore
                            ...
                            >
                                <Card.Meta
                                    // @ts-ignore
                                    title={<div style={styles.title} className="branch-title">{branch.name}</div>}
                                    // @ts-ignore
                                    description={<div style={styles.description} className="branch-description">{branch.description}</div>}
                                />
                            </Card>
                        </Col>
                    ))}
