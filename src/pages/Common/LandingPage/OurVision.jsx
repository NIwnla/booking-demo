        ...
        <div style={{ position: 'relative', zIndex: 1, backgroundColor: 'white' }}>
            ...
            <Row justify="space-between" align="middle" >
                <Col span={24} style={{ backgroundColor: 'rgb(56, 85, 214)', display: "flex", flexDirection: 'column', alignItems: 'center', color: 'white' }}>
                    <p style={{ fontSize: "1rem", marginTop: '5vh', fontWeight: 'bold' }}>OUR VISION</p>
                ...
                <Col xs={24} lg={10} style={{ height: '40vw' }}>
                    <div style={{
                        ...
                        <div>
                            <h2 style={{ margin: 0, fontSize: '3rem', color: 'white', padding: '3vh 2vw' }}>Join Us!</h2>
                            <p style={{ margin: 0, fontSize: '1.5rem', color: 'white', padding: '0 5vw 0 2vw' }}>Join us on the mission of sharing happiness, one pizza at a time.</p>
                        </div>
                        <div>
                            <Button
                                shape="circle"
