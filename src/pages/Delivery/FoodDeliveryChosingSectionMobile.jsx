    ...
    useEffect(() => {
        const checkPendingDelivery = async () => {
            try {
                ...
                console.error(t('delivery.foodChoice.fetchError'), error);
            }
        };
                                ...
                                label: (
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                        ...
                                        <Button
                                            ...
                                            onClick={onFinish}
                                        >
                                            {havePendingDelivery ? t('delivery.foodChoice.pendingDelivery') : t('delivery.foodChoice.proceedToCheckout')}
                                        </Button>
                                    </div>
                                ),
                                children: (
                                            ...
                                            return (
                                                <List.Item>
                                                    <List.Item.Meta
                                                        ...
                                                        title={name}
                                                        description={`${t('delivery.foodChoice.price')}: ${basePrice}đ`}
                                                    />
                                                    <Space>
